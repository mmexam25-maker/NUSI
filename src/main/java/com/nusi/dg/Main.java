...
public final class Main {
    ...
    private static final int MAX_PDF_BYTES =
            20 * 1024 * 1024;
    ...
    public static void main(
        ...
        System.out.println(
                "NUSI Membership 2026 started on port "
                        + port
        );
    }
    ...
    private static void slider(
        ...
        List<GoogleStore.SliderImage> images =
                GoogleStore.listSliderImages();
    ...
    private static void submit(
        ...
        try {
            ...
            System.out.println(
                    "NUSI SUBMIT | DG PHOTO START | INDoS "
                            + indos
            );


            DgPhotoService.PhotoResult photo =
            ...
            /*****************************************
             * SAVE TO GOOGLE DRIVE + SHEET
             *****************************************/

            GoogleStore.SavedMember saved =
                    GoogleStore.saveMember(
                            data,
                            photoBytes
                    );
    ...
    private static void validateSubmission(
         ...
         * MOBILE
         *
         * Mobile is optional in your current form.
         *********************************************/
    ...
    private static byte[] decodeFile(
            JsonNode node,
            String label,
            String expectedMime
    ) {
