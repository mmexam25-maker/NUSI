...
public final class GoogleStore {
    ...
    public record SavedMember(String photo, String folder, String address) {}
    ...
    public static SavedMember saveMember(
        ...
        List<Object> row = List.of(
                ...
                "",                                 // I CDC PDF (not used)
                "",                                 // J Passport PDF (not used)
                "",                                 // K Signature (not used)
                "",                                 // L SID
                address,                            // M Address
                buildNominee(data),                  // N Nominee
        ...
        return new SavedMember(photo.link(), folderLink, address);
    }
    ...
    private static String buildNominee(JsonNode data) {
        String type = text(data, "nomineeType").toUpperCase(Locale.ROOT);
        String name = text(data, "nomineeName");
        String phone = text(data, "nomineePhone");
